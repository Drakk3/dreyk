  ...
  const commandItems = useMemo<SharedCommandMenuItem[]>(() => {
    const globalItems: SharedCommandMenuItem[] = [
      ...
      },
      {
        ...
        onSelect: () => handleCommandNavigation('/life-plan?section=overview'),
        shortcut: '⌘ 3',
      },
      {
        ...
        onSelect: () => handleCommandNavigation('/life-plan?section=cash-flow'),
      },
      {
      ...
      },
      {
        ...
        onSelect: () => handleCommandNavigation('/life-plan?section=actions'),
      },
      {
