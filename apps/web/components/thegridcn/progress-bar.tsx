...
interface ProgressBarVariantConfig {
  bar: string
  glow: string
}

interface ProgressBarSizeConfig {
  text: string
  track: string
}

const variantColors: Record<NonNullable<ProgressBarProps['variant']>, ProgressBarVariantConfig> = {
...
const sizeConfig: Record<NonNullable<ProgressBarProps['size']>, ProgressBarSizeConfig> = {
